        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 pb-12 border-b border-cream/10">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                href="https://www.facebook.com/profile.php?id=61587265021762"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="CeyPall on Facebook"
              ...
              <a
                href="https://www.instagram.com/ceypall/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="CeyPall on Instagram"
                className="text-cream/50 hover:text-cream transition-colors duration-150"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <a
                href="https://www.linkedin.com/company/ceypall-pvt-ltd/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="CeyPall on LinkedIn"
                className="text-cream/50 hover:text-cream transition-colors duration-150"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
