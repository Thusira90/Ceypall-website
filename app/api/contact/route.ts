  ...
  const mailOptions = {
    ...
    html: `
      <table style="font-family:Arial,sans-serif;font-size:14px;color:#222;border-collapse:collapse;width:100%;max-width:600px">
        ...
        <tr><td style="padding:12px 24px;font-weight:bold;border-bottom:1px solid #eee">Company</td><td style="padding:12px 24px;border-bottom:1px solid #eee">${company || 'Not provided'}</td></tr>
        ...
        <tr><td style="padding:12px 24px;font-weight:bold;border-bottom:1px solid #eee">Quantity</td><td style="padding:12px 24px;border-bottom:1px solid #eee">${quantity || 'Not provided'}</td></tr>
