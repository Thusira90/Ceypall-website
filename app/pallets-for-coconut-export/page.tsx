...
export const metadata: Metadata = {
  ...
  description:
    'ISPM 15 heat-treated wooden pallets for Sri Lankan coconut product exporters. Kiln-dried below 15% MC for desiccated coconut, coconut oil, coconut cream, and coir products. IPPC stamped.',
  alternates: {
