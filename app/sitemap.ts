...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/wooden-pallets-ja-ela`,                    lastModified: new Date('2026-08-24'), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/wooden-pallets-kelaniya`,                  lastModified: new Date('2026-08-24'), changeFrequency: 'monthly', priority: 0.7 },
