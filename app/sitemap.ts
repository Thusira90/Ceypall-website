...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/euro-pallets-sri-lanka`,                   lastModified: new Date('2026-07-08'), changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/custom-wooden-pallets-sri-lanka`,          lastModified: new Date('2026-07-08'), changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/industrial-pallets-sri-lanka`,             lastModified: new Date('2026-07-08'), changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/wooden-pallets-colombo`,                   lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/wooden-pallets-katunayake`,                lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/wooden-pallets-negombo`,                   lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.7 },
