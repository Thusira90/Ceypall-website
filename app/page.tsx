...
export const metadata: Metadata = {
  ...
  description:
    'ISPM 15 heat-treated wooden pallets for Sri Lankan exporters — IPPC-stamped, NPQS-registered, 3–5 day island-wide delivery. Standard, Euro & custom sizes. Get a quote today.',
  alternates: {
